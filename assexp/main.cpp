...
// Here we group courses by semester
...
// Practically here we split hours into lab and lecture e.g if a course is 4 hours and has both lab and theory we split it into 2 hours of lab and 2 hours of theory
...
// We determine the available slots for the day
...
// We schedule the course within the available slots
for (size_t index = 0; index < availableSlots.size(); ++index) {
if (remainingHours <= 0) break;

TimeSlot& availableSlot = availableSlots[index];

// We choose to always schedule the lecture hours first
if (lectureHours > 0) {
...
//If a professor has hours that haven't been scheduled
if (remainingHours > 0) {
...
lectureRooms.push_back(LectureRoom("LectureRoom101", "Building A", 50, "Lecture Room"));
lectureRooms.push_back(LectureRoom("LectureRoom102", "Building B", 75, "Lecture Room"));
lectureRooms.push_back(LectureRoom("LectureRoom103", "Building C", 100, "Lecture Hall"));
lectureRooms.push_back(LectureRoom("LectureRoom104", "Building A", 50, "Lecture Room"));
lectureRooms.push_back(LectureRoom("LectureRoom105", "Building B", 75, "Lecture Room"));
lectureRooms.push_back(LectureRoom("LectureRoom106", "Building C", 100, "Lecture Room"));
lectureRooms.push_back(LectureRoom("LectureRoom107", "Building B", 75, "Lecture Room"));
lectureRooms.push_back(LectureRoom("LectureRoom108", "Building C", 100, "Lecture Hall"));

// Add some laboratory rooms
laboratories.push_back(Laboratory("LabRoom201", "Building A", 30, "Computer Lab1"));
laboratories.push_back(Laboratory("LabRoom202", "Building B", 25, "Computer Lab2"));
laboratories.push_back(Laboratory("LabRoom203", "Building C", 20, "Computer Lab3"));
laboratories.push_back(Laboratory("LabRoom204", "Building A", 30, "Computer Lab4"));
laboratories.push_back(Laboratory("LabRoom205", "Building B", 25, "Computer Lab5"));
laboratories.push_back(Laboratory("LabRoom206", "Building C", 20, "Computer Lab6"));
laboratories.push_back(Laboratory("LabRoom207", "Building B", 25, "Computer Lab5"));
laboratories.push_back(Laboratory("LabRoom208", "Building C", 20, "Computer Lab6"));

// Professor 1
vector<pair<int, int> > unavailability1;
unavailability1.push_back(pair<int, int>(8, 9));
unavailability1.push_back(pair<int, int>(8, 9));
unavailability1.push_back(pair<int, int>(15, 20));
...
unavailability2.push_back(pair<int, int>(14, 20));
unavailability2.push_back(pair<int, int>(8, 9));
unavailability2.push_back(pair<int, int>(9, 10));
unavailability2.push_back(pair<int, int>(14, 20));
unavailability2.push_back(pair<int, int>(14, 18));
...
unavailability3.push_back(pair<int, int>(14, 18));
unavailability3.push_back(pair<int, int>(9, 10));
unavailability3.push_back(pair<int, int>(18, 20));
unavailability3.push_back(pair<int, int>(9, 10));
unavailability3.push_back(pair<int, int>(16, 20));
...
unavailability4.push_back(pair<int, int>(9, 10));
unavailability4.push_back(pair<int, int>(8, 9));
unavailability4.push_back(pair<int, int>(9, 10));
unavailability4.push_back(pair<int, int>(9, 10));
